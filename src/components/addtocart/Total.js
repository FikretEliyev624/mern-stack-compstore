    ...
    <>
      <div className='h-28 dark:bg-darkmode'>
        ...
        <div className='flex bg-slate-500 h-16'>
            ...
            <p className='ml-28 mr-3 my-4 text-xl dark:text-white'>2339.00</p>
        ...
        <div className='mt-8 flex'>
            ...
            <button className='px-3 py-2  mx-32 rounded-lg text-white  bg-red-600 hover:bg-pink-500 '>Remove All</button>
        </div>
    </>
  )
}
